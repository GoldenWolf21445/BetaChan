...
public class HelpCommand implements ServerCommand {
    ...
    public void performCommand(String[] args, Member member, TextChannel channel, Message message) {
        ...
        if (args.length == 0) {
            ...
            builder.addField("Miscellaneous", "`eat [item]`, `help {cmd}`, `start`, `dungeon [@user,...]`, `enchant [#]`, `equip [item]`, `shop {item} {amount}`, `money {pay} {@user} {amount}`", false);
            ...
            if (args[0].equalsIgnoreCase("dungeon")) {
            ...
            } else if (args[0].equalsIgnoreCase("chop")) {
                builder.setTitle("Chop");
                builder.addField("Command", "Chop", false);
                builder.addField("Usage:", "chop", false);
                builder.addField("Information:", "Used to chop down Trees", false);
                ...
                builder.addField("Information:", "Used to pickup Food", false);

            } else if (args[0].equalsIgnoreCase("smelt")) {
                builder.setTitle("Smelt");
                builder.addField("Command", "Smelt", false);
                builder.addField("Usage:", "smelt [wood/coal] [amount]", false);
                builder.addField("Information:", "Used to smelt Raw Ores into Ingots", false);

            } else if (args[0].equalsIgnoreCase("cook")) {
                builder.setTitle("Cook");
                builder.addField("Command", "Cook", false);
                builder.addField("Usage:", "cook [coal/wood] [item]", false);
                builder.addField("Information:", "Used to Cook your Food", false);

            } else if (args[0].equalsIgnoreCase("eat")) {
                builder.setTitle("Eat");
                builder.addField("Command", "Eat", false);
                builder.addField("Usage:", "eat [item]", false);
                builder.addField("Information:", "Used to Eat your cooked Items or drink your potions", false);
